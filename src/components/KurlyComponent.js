                            ...
                            <li>
                                <div className="gap">
                                    ...
                                    <div className="input-box">
                                        ...
                                        <button onClick={this.onClickPhoneEvent} className={`w120-btn ${this.state.isPhoneClass ? '': 'phone'}`} disabled={this.disabled1}>인증번호받기</button>
                                        {
                                            this.state.isPhoneOkOpen && (
                                                <>
                                                    <input type="text" maxLength='6' className='inputText' id='inputPhone1' placeholder='인증번호를 입력하세요' disabled={this.disabled2} value={this.state.휴대폰인증}  onChange={(e)=>this.onChangePhoneOk(e.target.value)}/>
                                                    <button onClick={this.onClickPhoneOkEvent} className={`w120-btn phoneok-btn ${this.state.isPhoneOkClass? '' : 'phone'}`}>인증번호확인</button>
